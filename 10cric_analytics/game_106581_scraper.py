...
class Game106581Scraper(BaseScraper):
    def __init__(self):
        super().__init__(
            name="game_106581",
            url="https://www.10cric247.com/game/?launch=106581"
        )
    ...
    async def scrape(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info("Game 106581 Scraper run successfully.")
            return result

        except Exception as e:
            self.logger.error(f"Error executing Game 106581 Scraper: {e}", exc_info=True)
            raise e
        finally:
            await self.close_browser()

if __name__ == "__main__":
    scraper = Game106581Scraper()
